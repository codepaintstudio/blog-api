...
<template>
  <div
    class="border border-[var(--color-border-default)] rounded overflow-hidden bg-[var(--color-canvas-default)]"
  >
    <editor-content
      :editor="editor"
    ...
    />
    <div
      class="bg-[var(--color-canvas-subtle)] border-t border-[var(--color-border-default)] p-2 flex items-center gap-2"
    >
      <button
